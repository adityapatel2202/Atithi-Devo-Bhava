...
<div role="tabpanel" class="tab-pane <?php if($i==0) {	echo " active "; $i=1;} ?>" id="<?php echo $rstourism_location['location_name']; ?><?php $rstourism_location[0]; ?>">
	...
	<div class="mg_hotel_destination_wrapper">
		<div class="row">
<?php
	$sqltourism_place ="SELECT tourism_place.*,tourism_location.location_name FROM tourism_place LEFT JOIN tourism_location ON tourism_location.location_id=tourism_place.location_id WHERE tourism_location.location_id='$rstourism_location[0]' LIMIT 3 DESC";
