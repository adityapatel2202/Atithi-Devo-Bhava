...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="INSERT INTO hotel_facility(hotel_id,room_typeid,facility_type,facility_img,status) values('$_POST[hotel_id]','$_POST[room_typeid]','$_POST[facility_type]','$img','$_POST[status]')";
		$qsql = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con) ==  1)
		{
