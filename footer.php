                ...
                <div class="container">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget widget_text">
                            <div class="logo">
                                <a href="#"><img src="images/logo (3).png" alt="" style="height: 30px;" /></a>
                            </div>
                            <div class="text">
...
<i class="fa fa-phone"></i><span> +91-1234567890</span>
<hr>
</div>
<div class="mg_contact"><i class="fa fa-envelope-o"></i><span> info@atithidevobhava.com</span><hr></div>
<br>
                            <ul class="mg_social">
            ...
            <div class="mg_copyright">
                <p>Copyrights 2022. All rights reserved | Developed by : Aditya & Harsiddh 
...
if(!isset($_SESSION[staffid]))
{
	...
	{
?>
 <a class="mg_login_btn" data-toggle="modal" data-target="#StaffLoginModal" href="#">Admin Login</a>
<?php	
	}
}
?>
