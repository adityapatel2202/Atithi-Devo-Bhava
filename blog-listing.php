                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mg_blog_listing fancy-overlay">
                                    <div class="thumb">
                                        <img src="extra-images/blog_listing1.jpg" alt="">
                                        <a class="mg_zoom_icon" href="#"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="text">
                                        <h5 class="blog_title"><a href="#">consetetur sadipscing elitr sed diam nonumy eirmod</a></h5>
                                        <ul class="blog-meta-list">
                                            <li><span>Monday April 22nd, 2015</span></li>
                                        </ul>
                                        <div class="clear"></div>
                                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.mata sanctus est Lorem ipsum dolor sit amet.</p>
                                ...
                                <div class="mg_blog_listing fancy-overlay">
                                    <div class="thumb">
                                        <img src="extra-images/blog_listing2.jpg" alt="">
                                        <a class="mg_zoom_icon" href="#"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="text">
                                        <h5 class="blog_title"><a href="#">consetetur sadipscing elitr sed diam nonumy eirmod</a></h5>
                                ...
                                <div class="mg_blog_listing fancy-overlay">
                                    <div class="thumb">
                                        <img src="extra-images/blog_listing3.jpg" alt="">
                                        <a class="mg_zoom_icon" href="#"><i class="fa fa-search"></i></a>
                                    </div>
                                    <div class="text">
                                        <h5 class="blog_title"><a href="#">consetetur sadipscing elitr sed diam nonumy eirmod</a></h5>
