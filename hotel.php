...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="INSERT INTO hotel(location_id,hotel_name,hotel_type,hotel_description,hotel_address,hotel_map,hotel_pincode,hotel_policies,status) values('$_POST[location_id]','$_POST[hotel_name]','$_POST[hotel_type]','$_POST[hotel_description]','$_POST[hotel_address]','$_POST[hotel_map]','$_POST[hotel_pincode]','$_POST[hotel_policies]','$_POST[status]')";
		$qsql = mysqli_query($con,$sql);
		if(mysqli_affected_rows($con) ==  1)
		{
